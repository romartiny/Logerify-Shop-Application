            ...
            <div class="overview">
                ...
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <span class="number"><?php echo e($todayAdminEvents); ?></span>
                        <span class="text">events for 24 hours</span>
                    </div>
                    <div class="box box2">
                        <i class="uil uil-clock"></i>
                        <span class="number"><?php echo e($threeDayAdminEvents); ?></span>
                        <span class="text">events for 3 days</span>
                    </div>
                    <div class="box box3">
                        <i class="uil uil-clock-five"></i>
                        <span class="number"><?php echo e($monthAdminEvents); ?></span>
...
<?php /**PATH /Users/romartiny/Documents/GitHub/Logerify/logerify/resources/views/layouts/AdminLayout/adminBlock.blade.php ENDPATH**/ ?>
